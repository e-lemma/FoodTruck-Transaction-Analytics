...
def lambda_handler(event, context):
    ...
    try:
        ...
        transaction_data = get_transaction_data(conn, yesterdays_date)
        transaction_data["total"] = pd.to_numeric(transaction_data["total"])

        html_report = generate_html_report(transaction_data, yesterdays_date)
